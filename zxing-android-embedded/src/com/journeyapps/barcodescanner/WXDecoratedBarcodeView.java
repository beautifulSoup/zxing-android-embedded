 ...
 */
public class WXDecoratedBarcodeView extends FrameLayout{
    private BarcodeView barcodeView;
    private WXViewfinderView viewFinder;
    ...
    public WXDecoratedBarcodeView(Context context) {
        super(context);
        initialize();
    }

    public WXDecoratedBarcodeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initialize(attrs);
    }

    public WXDecoratedBarcodeView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initialize(AttributeSet attrs) {
        ...
        int scannerLayout = attributes.getResourceId(
                R.styleable.zxing_view_zxing_scanner_layout, R.layout.zxing_wx_barcode_scanner);
        ...
        viewFinder = (WXViewfinderView) findViewById(R.id.zxing_viewfinder_view);
    ...
    public void initializeFromIntent(Intent intent) {
        ...
        if (customPromptMessage != null) {
            viewFinder.setStatusText(customPromptMessage);
        }
    ...
    public WXViewfinderView getViewFinder() {
        return viewFinder;
    }
