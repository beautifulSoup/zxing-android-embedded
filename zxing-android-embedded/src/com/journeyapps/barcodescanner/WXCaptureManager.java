...
/**
 * Created by kris on 16/9/21.
 */
public class WXCaptureManager {
    private static final String TAG = CaptureManager.class.getSimpleName();

    private static int cameraPermissionReqCode = 250;

    private Activity activity;
    private WXDecoratedBarcodeView barcodeView;
    ...
    public WXCaptureManager(Activity activity, WXDecoratedBarcodeView barcodeView) {
    ...
    public static void setCameraPermissionReqCode(int cameraPermissionReqCode) {
        WXCaptureManager.cameraPermissionReqCode = cameraPermissionReqCode;
    }
}
